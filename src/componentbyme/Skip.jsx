...
import { SkiperCard } from "../components/ui/skiper-card.jsx";
            ...
            <div className="mx-auto max-w-4xl rounded-[34px] bg-neutral-700">
              <div className="relative z-10 grid w-full gap-8 rounded-[28px] bg-neutral-950 p-2">
                <SkiperCard
                  ...
                  image={{
                    step1light1: "/hxh.jpg",
                    step1light2: "/Luffy _ One Piece Wallpaper.jpg",
                    step2light1: "/naruto.jpg",
                    step2light2: "/renguku.jpg",
                    step3light: "/sinchan.jpg",
                    step4light: "/sinchan2.jpg",
