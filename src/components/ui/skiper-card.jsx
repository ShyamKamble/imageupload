...
// FeatureCard: Wrapper for animated card with mouse tracking
...
// SkiperCard component with animated image steps
export function SkiperCard({
  ...
  return (
    <FeatureCard {...props}>
      {/* Step 4 image - shown when step < 3 */}
      <div
        className={cn(
      ...
      <>
        ...
        <Image
          ...
          width={400} // Set your actual or desired size here
          height={300} 
          style={{
            position: "absolute",
            userSelect: "none",
...
export function useIsMobile() {
  ...
  useEffect(() => {
    ...
    if (isDev) setIsMobile(isSmall || isMobileTemp);

    setIsMobile(isSmall && isMobileTemp);
  }, []);
